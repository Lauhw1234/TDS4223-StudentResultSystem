...
public:
    ...
    /* -------------------- Main Staff Menu Loop: Leong Sze Kai --------------------
       Required owner: add/edit/delete course, attendance recording/sorting,
       at-risk students report, and summary report save/load.
       Extra shared functions assigned here: course display and attendance search. */
    void run() {
        if (!login()) return;
        int choice = -1;
        while (choice != 0) {
            cout << "\n================ ADMIN MENU - LEONG SZE KAI ================\n";
            cout << " 1. Add Course\n";
            cout << " 2. Edit Course\n";
            cout << " 3. Display All Courses\n";
            cout << " 4. Delete Course\n";
            cout << " 5. Generate Summary Report (save to txt)\n";
            cout << " 6. View Summary Report (load from txt)\n";
            cout << " 7. Record / Update Attendance\n";
            cout << " 8. View All Attendance (Sorted)\n";
            cout << " 9. Search Attendance by Student ID\n";
            cout << "10. At-Risk Students Report\n";
            cout << " 0. Logout\n";
            cout << "============================================================\n";
            choice = readInt("Enter choice: ");

            switch (choice) {
                case 1: addCourseMenu(); break;
                case 2: editCourseMenu(); break;
                case 3: mgr.displayAllCourses(); break;
                case 4: deleteCourseMenu(); break;
                case 5: generateReportMenu(); break;
                case 6: viewReportMenu(); break;
                case 7: recordAttendanceMenu(); break;
                case 8: viewAllAttendanceSortedMenu(); break;
                case 9: searchAttendanceByStudentMenu(); break;
                case 10: atRiskStudentsMenu(); break;
                case 0: logout(); break;
...
/* ============================================================================
   PART 9: MAIN PROGRAM ENTRY POINT - LEONG SZE KAI ADMIN PART
   ============================================================================ */
...
void printWelcomeBanner() {
    ...
    cout << "#      ADMIN PART - LEONG SZE KAI\n";
    cout << "#      242DT242GK / Report - PART 5\n";
    cout << "#                                                      #\n";
    cout << "########################################################\n";
}
...
int main() {
    ...
    while (mainChoice != 0) {
        printWelcomeBanner();
        cout << "\n1. Admin Login - LEONG SZE KAI Functions\n";
        cout << "0. Exit System\n";
        cout << "Enter choice: ";
