...
const char ATTENDANCE_FILE[] = "attendance.txt";
 ...
 //date structure used across student, staff and result records.
...
struct Date {
    ...
    Date() {                       
        day = 1; month = 1; year = 2026;//default constructor
    }
    Date(int d, int m, int y) {   
        day = d; month = m; year = y; //prmeterised const
    }
...
//hold contact details shared by student and staff
...
// i removed the "type your own ID" part. the system will give the student an ID automatically after the registration is done.
    ...
    /* -------------------- Main Customer Menu Loop: Lau Hui Weng -------------------- */
    void run() {
        if (!login()) return;
        int choice = -1;
        while (choice != 0) {
            cout << "\n================ STUDENT MENU - LAU HUI WENG ================\n";
            cout << " 1. Update Contact Info\n";
            cout << " 2. Change Password\n";
            cout << " 3. Update Programme\n";
            cout << " 4. See My Detail\n";
            cout << " 5. See My Result\n";
            cout << " 6. View My Attendance\n";
            cout << " 7. Sort My Attendance by Percentage\n";
            cout << " 8. View My Rank in a Course\n";
            cout << " 9. Check My GPA Standing\n";
            cout << " 0. Logout\n";
            cout << "==============================================================\n";
            choice = readInt("Enter choice: ");

            switch (choice) {
                case 1: updateContactInfo(); break;
                case 2: editOwnPassword(); break;
                case 3: editOwnProgramme(); break;
                case 4: displayMyProfile(); break;
                case 5: displayMyResults(); break;
                case 6: viewMyAttendance(); break;
                case 7: sortMyAttendanceMenu(); break;
                case 8: viewMyRankInCourseMenu(); break;
                case 9: viewMyGpaPercentileMenu(); break;
                case 0: logout(); break;
...
/* ============================================================================
   PART 10: MAIN PROGRAM ENTRY POINT - LAU HUI WENG CUSTOMER PART
   ============================================================================ */
...
void printWelcomeBanner() {
    ...
    cout << "#      CUSTOMER PART - LAU HUI WENG                    #\n";
    cout << "#                                                      #\n";
    cout << "########################################################\n";
}
...
int main() {
    ...
    while (mainChoice != 0) {
        printWelcomeBanner();
        cout << "\n1. Student Login - Lau Hui Weng Customer Functions\n";
        ...
        switch (mainChoice) {
            ...
            case 2: customerModule.registerNewStudent(); break;
