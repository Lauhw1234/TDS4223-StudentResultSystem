...
public:
    ...
    /* -------------------- Main Staff Menu Loop: Tan Kai Feng --------------------
       Required owner: search student by ID/name, sort students by name/GPA,
       course analytics, student rank, and grade distribution chart.
       Extra shared functions assigned here: student list display and activity-log search. */
    void run() {
        if (!login()) return;
        int choice = -1;
        while (choice != 0) {
            cout << "\n================ ADMIN MENU - TAN KAI FENG ================\n";
            cout << " 1. Show All Student List\n";
            ...
            cout << " 6. Search Activity Log\n";
            cout << " 7. Course Analytics (avg, top, bottom)\n";
            cout << " 8. Student Rank in a Course\n";
            cout << " 9. Grade Distribution Chart\n";
            cout << " 0. Logout\n";
            cout << "===========================================================\n";
            ...
            switch (choice) {
                ...
                case 2: searchStudentByIdMenu(); break;
                case 3: searchStudentByNameMenu(); break;
                case 4: sortStudentsByNameMenu(); break;
                case 5: sortStudentsByGpaMenu(); break;
                case 6: searchActivityLogMenu(); break;
                case 7: courseAnalyticsMenu(); break;
                case 8: studentRankMenu(); break;
                case 9: mgr.displayGradeChart(); break;
                case 0: logout(); break;
...
/* ============================================================================
   PART 9: MAIN PROGRAM ENTRY POINT - TAN KAI FENG ADMIN PART
   ============================================================================ */
...
void printWelcomeBanner() {
    ...
    cout << "#      ADMIN PART - TAN KAI FENG\n";
    cout << "#      242DT243MM / Report - PART 4\n";
    cout << "#                                                      #\n";
    cout << "########################################################\n";
}
...
int main() {
    ...
    while (mainChoice != 0) {
        printWelcomeBanner();
        cout << "\n1. Admin Login - TAN KAI FENG Functions\n";
        cout << "0. Exit System\n";
        cout << "Enter choice: ";
