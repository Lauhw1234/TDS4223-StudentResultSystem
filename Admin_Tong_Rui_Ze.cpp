...
public:
    ...
    /* -------------------- Main Staff Menu Loop: Tong Rui Ze --------------------
       Required owner: Admin login, add result, edit result, delete result.
       Extra shared functions assigned here: staff registration, result display/sort,
       remark request queue, and recent activity log. */
    void run() {
        if (!login()) return;
        int choice = -1;
        while (choice != 0) {
            cout << "\n================ ADMIN MENU - TONG RUI ZE ================\n";
            cout << " 1. Register New Staff\n";
            cout << " 2. Key In Student Marks\n";
            cout << " 3. Edit Result Record\n";
            cout << " 4. Show All Marks Record\n";
            cout << " 5. Sort Results by Marks\n";
            cout << " 6. Delete Result Record\n";
            cout << " 7. View Remark Request Queue\n";
            cout << " 8. Process Next Remark Request\n";
            cout << " 9. View Recent Activity Log\n";
            cout << " 0. Logout\n";
            cout << "==========================================================\n";
            ...
            switch (choice) {
                ...
                case 2: addResultMenu(); break;
                case 3: editResultMenu(); break;
                case 4: displayAllResults(); break;
                case 5: sortResultsByMarksMenu(); break;
                case 6: deleteResultMenu(); break;
                case 7: viewRequestList(); break;
                case 8: processNextRemarkRequest(); break;
                case 9: viewActivityLogMenu(); break;
                case 0: logout(); break;
...
/* ============================================================================
   PART 9: MAIN PROGRAM ENTRY POINT - TONG RUI ZE ADMIN PART
   ============================================================================ */
...
void printWelcomeBanner() {
    ...
    cout << "#      ADMIN PART - TONG RUI ZE\n";
    cout << "#      242DT241R7 / Report - PART 3\n";
    cout << "#                                                      #\n";
    cout << "########################################################\n";
}
...
int main() {
    ...
    while (mainChoice != 0) {
        printWelcomeBanner();
        cout << "\n1. Admin Login - TONG RUI ZE Functions\n";
        cout << "0. Exit System\n";
        cout << "Enter choice: ";
