...
// i removed the "type your own ID" part. the system will give the student an ID automatically after the registration is done.
    ...
    /* -------------------- Main Customer Menu Loop: Lye Chia Ee -------------------- */
    void run() {
        if (!login()) return;
        int choice = -1;
        while (choice != 0) {
            cout << "\n================ STUDENT MENU - LYE CHIA EE ================\n";
            cout << " 1. Submit Remark Request\n";
            cout << " 2. Search My Results by Course Code\n";
            cout << " 3. Search Available Course by Code\n";
            cout << " 4. Sort My Results by Marks\n";
            cout << " 5. Sort My Results by Course Code\n";
            cout << " 6. Cancel a Remark Request (FIFO)\n";
            cout << " 7. Generate My Summary Report (save to txt)\n";
            cout << " 8. View My Summary Report (load from txt)\n";
            cout << " 0. Logout\n";
            cout << "============================================================\n";
            ...
            switch (choice) {
                ...
                case 2: searchMyResultByCourseMenu(); break;
                case 3: searchAvailableCourseMenu(); break;
                case 4: sortMyResultsByMarksMenu(); break;
                case 5: sortMyResultsByCourseCodeMenu(); break;
                case 6: cancelRemarkRequest(); break;
                case 7: generateReportMenu(); break;
                case 8: viewReportMenu(); break;
                case 0: logout(); break;
...
/* ============================================================================
   PART 10: MAIN PROGRAM ENTRY POINT - LYE CHIA EE CUSTOMER PART
   ============================================================================ */
...
void printWelcomeBanner() {
    ...
    cout << "#      CUSTOMER PART - LYE CHIA EE                     #\n";
    cout << "#                                                      #\n";
    cout << "########################################################\n";
}
...
int main() {
    ...
    while (mainChoice != 0) {
        printWelcomeBanner();
        cout << "\n1. Student Login - Lye Chia Ee Customer Functions\n";
